...
{ 
  ...
  public Deck(Deck d) {
    _rand  = new Random ((new Date()).getTime());
    _cards = Arrays.copyOf(d._cards, d._cards.length);
    _inDeck = Arrays.copyOf(d._inDeck, d._inDeck.length);
    _currentCard = d._currentCard;
    _shuffled = d._shuffled;
    _cardsRemoved = d._cardsRemoved;
  }
