from trainer_smaller import Trainer
from state_smaller import get_root_state
import time
import random
import pickle
import numpy as np
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if t % SAVE_TO_DISK_INTERVAL == 0:
            ...
            with open('nodemap_smaller.pickle', 'wb') as f:
                pickle.dump(node_map_save, f, protocol=pickle.HIGHEST_PROTOCOL)
            with open('avgstrategy_smaller.pickle', 'wb') as f:
